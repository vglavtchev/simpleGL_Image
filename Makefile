...
build: simpleGL_Image

simpleGL.o: simpleGL.cpp
	$(GCC) $(CCFLAGS) $(EXTRA_CCFLAGS) $(INCLUDES) -o $@ -c $<

simpleGL_kernel.o: simpleGL_kernel.cu
	$(NVCC) $(NVCCFLAGS) $(EXTRA_NVCCFLAGS) $(GENCODE_FLAGS) $(INCLUDES) -o $@ -c $<

simpleGL_Image: simpleGL.o simpleGL_kernel.o
...
clean:
	rm -f simpleGL.o simpleGL_kernel.o simpleGL_Image.bin simpleGL_Image
